...
$faq = [
    ...
    'ThirdQA' => [
        ...
        <ol> <li> La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti: <ul> <li> Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera. </li> <li> Google LLC, con sede negli Stati Uniti, per il resto del mondo. </li> </ul>
...
<body>
    ...
    <main>
        <div class="container">
            <?php 
                foreach($faq as $chiave => $valore ) {
                    echo "<h3 class='question'>" . $valore['question'] . "</h3>";
                    echo "<p class='answer'>" . $valore['answer'] . "</p>";
                }
